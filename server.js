...
<head>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .news-dropdown{min-width:360px!important;max-width:400px!important;grid-template-columns:1fr!important;padding:10px!important}.news-dropdown a{grid-column:1/-1!important;white-space:normal}.news-dropdown a span:last-child{overflow:hidden}.news-dropdown a strong{display:block;font-size:.84rem;line-height:1.3;white-space:normal;word-break:break-word}.news-dropdown a small{display:block;font-size:.75rem;color:#94a3b8;margin-top:2px}
